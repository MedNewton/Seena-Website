...
import CirclesActivityCard from "./CirclesActivityCard";

export type CirclesActivity = {
  id: string;
  title: string;
  image: StaticImageData;
};

export type CirclesSectionConfig = {
  id: string;
  title: string;
  activities: CirclesActivity[];
};

export interface CirclesSectionSliderProps {
  config: CirclesSectionConfig;
}

const MotionBox = motion.create(Box);

const CirclesSectionSlider: FC<CirclesSectionSliderProps> = ({
  config,
}) => {
    ...
    <Stack spacing={1.5}>
      ...
      <MotionBox
        ...
        sx={(theme) => ({
          ...
          "--circles-track-padding-y": theme.spacing(1),
        })}
      >
        <Box sx={{ position: "relative" }}>
          ...
          {/* Edge blur overlays (same height as slider) */}
          <Box
            aria-hidden
            sx={{
              position: "absolute",
              left: 0,
              right: 0,
              top: "var(--circles-track-padding-y)",
              height: "var(--circles-card-height)",
              pointerEvents: "none",
              zIndex: 1,
            }}
          >
...
export default CirclesSectionSlider;
