// src/components/reset/SeenaResetBackgroundLayer.tsx
"use client";

import type { FC } from "react";
import { Box } from "@mui/material";

const SeenaResetBackgroundLayer: FC = () => {
  return (
    <Box
      aria-hidden="true"
      sx={{
        ...
        "&::after": {
          ...
          position: "absolute",
          inset: 0,
          // soft teal/navy darkening to keep text readable
          background:
            "radial-gradient(circle at top, rgba(15,35,45,0.18) 0%, rgba(10,25,38,0.6) 55%, rgba(5,15,25,0.85) 100%)",
...
export default SeenaResetBackgroundLayer;
