...
import ResetActivityCard from "./ResetActivityCard";

export type ResetActivity = {
  id: string;
  title: string;
  image: StaticImageData;
};

export type ResetSectionConfig = {
  id: string;
  title: string;
  activities: ResetActivity[];
};

export interface ResetSectionSliderProps {
  config: ResetSectionConfig;
}

const MotionBox = motion.create(Box);

const ResetSectionSlider: FC<ResetSectionSliderProps> = ({
  config,
}) => {
...
export default ResetSectionSlider;
